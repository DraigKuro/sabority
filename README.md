...
3. El personal del restaurante gestiona los pedidos, mesas y el menú desde el panel de administración (`sabority-web`).

## Evolución del proyecto

La primera versión de Sabority (`sabority-web-legacy`) resolvía el pedido desde la mesa también mediante un cliente web. Esa parte evolucionó hacia una app Android nativa (`sabority-android`), pensada para dar una mejor experiencia al cliente en el momento de pedir, mientras que la gestión por parte del restaurante se mantuvo y creció como aplicación web (`sabority-web`).
